...
@pytest.mark.django_db
def test_user_retrieve_page(client_with_pages, page_ids, user_token, page_public):
...
@pytest.mark.django_db
def test_user_can_retrieve_private_page(client_with_pages, page_ids, user_token, page_private):
...
@pytest.mark.django_db
def test_user_can_retrieve_blocked_page(client_with_pages, page_ids, user_token, page_blocked):
